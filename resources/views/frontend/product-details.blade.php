			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						@foreach ($productsgallery as $item)
							<div class="col-sm-5">
							...
							<div class="col-sm-7">
								<div class="product-information"><!--/product-information-->
									...
									<img src="../frontend/images/rating.png" alt="" /> <br>
									<span>
										<span>Price: ${{ $item->money }}</span> <br>
									...
									<a href="{{ route('addTocart', $item->productgallery_id) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								<div class="item active">
									@foreach($productsgallery1 as $product)	
										<div class="col-sm-4">
											<div class="product-image-wrapper">
												<div class="single-products">
													<div class="productinfo text-center">
